...
--TODO: UNIFORMARE IL MODO IN CUI ACQUISISCO L'INTERFACCIA SU CUI STO MONITORANDO
----------------------------------
------IN CORSO---------
---------------------
...
-- (getnDPIStats è relativo allecomunicazioni degli ultimi minuti, se voglio sapere il volume del traffico applicativo fin dall'avvio allora devo vedere if_stats)
...
function network_state.check_devices_type() --TODO: SISTEMARE!
...
function network_state.check_bad_hosts_and_app()
  ...
  callback.foreachHost(if_stats.name, os.time()+4000, mycallback )
...
----__----_---__---_---__--__--_---_---_--_---_--__--_--__--_---_--__--_---__--_--___-__--__--__-__--__--___-
require "alert_utils"
...
function network_state.alerts_details()
  ...
  local alert_type, rowid, t_stamp, srv_addr, srv_port, cli_addr, cli_port, severity, alert_json  --todo: CHIEDI DEI CAMPI L7_PROTO e PROTO
